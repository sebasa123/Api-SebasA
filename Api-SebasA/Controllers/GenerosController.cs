...
namespace Api_SebasA.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        public GenerosController(BD_PROY_P6Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Genero>> PostGenero(Genero genero)
        {
          if (_context.Generos == null)
          {
              return Problem("Entity set 'BD_PROY_P6Context.Generos'  is null.");
          }
        ...
        {
            return (_context.Generos?.Any(e => e.Idgen == id)).GetValueOrDefault();
        }
    }
}
